...
sleep 7
xterm -e "source /home/workspace/catkin_ws/devel/setup.bash; roslaunch turtlebot_gazebo gmapping_demo.launch custom_gmapping_launch_file:="/home/workspace/catkin_ws/src/home_service_robot/turtlebot_simulator/turtlebot_gazebo/launch/myworld_slam.launch.xml" " &
sleep 5
